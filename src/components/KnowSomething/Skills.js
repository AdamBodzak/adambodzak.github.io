            ...
            <ul className={styles.courseList}>
                <li className={styles.courseItem}>
                    <article className={styles.courseItem__article}>
                        5 godz. kurs <b> React od podstaw </b> prowadzony przez <b> Adama Romanowskiego </b> na platformie <a target={'_blank'} rel={"noreferrer"} href={'https://eduweb.pl/programowanie-i-www/reactjs/react-od-podstaw'}>eduweb.pl</a>. W ramach kursu powstała aplikacja do zarządzania wiadomościami z twitter-a, artykułami oraz notatkami. Zapraszam do obejrzenia mojego repozytorium na <a target={'_blank'} rel={"noreferrer"} href={'https://github.com/AdamBodzak/AdamRomanowski_kursReactOdPodstaw.git'}>GitHub</a> oraz rezultatów mojej pracy na serwerze <a target={'_blank'} rel={"noreferrer"} href={'https://adam-romanowski-kurs-react-od-podstaw-adambodzak.vercel.app/'}>Vercel</a>. Wersja ostateczna projektu została przeze mnie wzbogacona o dodatkowe funkcjonalności o których można szerzej poczytać w pliku <a target={'_blank'} rel={"noreferrer"} href={'https://github.com/AdamBodzak/AdamRomanowski_kursReactOdPodstaw#readme'}> README.md </a> dołączonym do repozytorium GitHub.
                    </article>
                </li>
                <li className={styles.courseItem}>
                    <article className={styles.courseItem__article}>
                ...
                <li className={styles.courseItem}>
                    <article className={styles.courseItem__article}>
                        12 tygodniowy <b> kurs nauki React </b> prowadzony przez <b> Michała Taszyckiego </b> na stronie internetowej <a target={'_blank'} rel={"noreferrer"} href={'https://kursreacta.pl'}>Kurs React-a</a>. Kurs składa się z dwóch części:
                        <p className={styles.courseItem__paragraf}>
                            - Część pierwsza <b> Kurs Reacta - Szybki Start </b> w ramach kursu powstała aplikacja której zadaniem jest odtwarzanie muzyki  dostarczanej z serwera zewnętrznego. Zapraszam do obejrzenia mojego repozytorium na <a target={'_blank'} rel={"noreferrer"} href={'https://github.com/AdamBodzak/CourseReact_QuickStart_MichalTaszycki'}>GitHub</a> oraz rezultatów mojej pracy na serwerze <a target={'_blank'} rel={"noreferrer"} href={'https://course-react-quick-start-michal-taszycki.vercel.app/'}>Vercel</a>.
                        </p>
                        <p className={styles.courseItem__paragraf}>
                            - Część dróga <b>Kurs Reacta - Fundamenty i Kurs Reacta - Expert</b> W ramach kursu powstała aplikacja do odliczania interwałów czasowych dla poszczególnych zadań.
                        </p>
